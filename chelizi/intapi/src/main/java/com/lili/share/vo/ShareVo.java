...
/**
	 * 
	 */
	private static final long serialVersionUID = 1943209340919017671L;
/*主键*/
  private Integer sid;
/*分享用户或用户类*/
  private String suid;
...
/*发送人的用户类型：1代表教练，2代表学员，3管理后台用户,4校园代理，5推广渠道（数据写入专门的渠道表）*/
...
/*更新时间*/
  ...
  public String toString() {
		return "{sid="+sid+",suid="+suid+",sendPhone="+sendPhone+",sendType="+sendType+",sendUser="+sendUser+",sendState="
				+sendState+",sendTime="+sendTime+",sendTotal="+sendTotal+",recevieName="+recevieName+",receviePhone="
					+receviePhone+",recevieUser="+recevieUser+",recevieState="+recevieState+",recevieCoupon="+recevieCoupon+",regName="
				+regName+",regPic="+regPic+",regType="+regType+",checkState="+checkState+",isdel="+isdel+",cuid="+cuid+",muid="
					+muid+",ctime="+ctime+",mtime="+mtime +",recevieTemplate="+recevieTemplate+"}";
  }
}
