...
public class CoachLevelQuery extends BaseQuery {
	private String sqlField="colid as colid,name as name,prate as prate,isdel as isdel,cuid as cuid,muid as muid,ctime as ctime,mtime as mtime";
