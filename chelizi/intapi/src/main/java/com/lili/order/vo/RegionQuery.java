...
public class RegionQuery extends BaseQuery {
	private String sqlField="rid as rid,region as region,rlevel as rlevel,pid as pid,isdel as isdel,cuid as cuid,muid as muid,ctime as ctime,mtime as mtime";
