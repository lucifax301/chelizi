...
public class CarLevelQuery extends BaseQuery {
	private String sqlField="calid as calid,name as name,prate as prate,isdel as isdel,cuid as cuid,muid as muid,ctime as ctime,mtime as mtime";
