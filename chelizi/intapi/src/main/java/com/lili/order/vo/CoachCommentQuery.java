...
public class CoachCommentQuery extends BaseQuery {
	private String sqlField="ccid as ccid,student_id as studentId,coach_id as coachId,order_id as orderId,course_id as courseId,score as score,ctid as ctid,one_word as oneWord,cotime as cotime,anonymity as anonymity";
