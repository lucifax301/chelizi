 ...
 *
 */
public class QQPayCallbackResData implements Serializable
{
    private static final long serialVersionUID = 4648684880236934016L;
    private String ver;
    ...
    /**
     * @param purchase_alias the purchase_alias to set
     */
