...
import com.lili.qqpay.config.QQPayInitRsp;
import com.lili.qqpay.config.QQPayRequest;
...
public class QQPayBussiness
{
     ...
     * @return
     */
    public static ReqResult doQQPayInit(com.lili.qqpay.config.QQPayInitReq qqPayInitReq, String url)
    {
        ...
        try
        {
            ...
            com.lili.qqpay.config.QQPayInitRsp qqPayInitResp = (com.lili.qqpay.config.QQPayInitRsp) Util.getObjectFromXML(
