...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara, String signType) {
		//除去数组中的空值和签名参数
        Map<String, String> sParaTemp = AlipayCore.paraFilter(sPara);
     ...
     * @return 要请求的参数数组
     */
    private static Map<String, String> buildRequestPara(Map<String, String> sPara, String signType) {
        //生成签名结果
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName, String signType) {
        //待请求参数数组
