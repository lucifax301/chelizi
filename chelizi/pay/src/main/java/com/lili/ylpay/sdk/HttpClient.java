...
import com.lili.ylpay.sdk.BaseHttpSSLSocketFactory.TrustAnyHostnameVerifier;
...
public class HttpClient {
	...
	public static void main(String[] args) {
		...
		submitFromData.put("merId","808080211302274");
		HttpClient hc = new HttpClient("https://verifycert.chinapay.com/serverSHA256NewSSL/sslServlet", 30000, 30000);
		try {
