...
public class RefundQueryReqData {
    ...
    public RefundQueryReqData(String transactionID,String outTradeNo,String deviceInfo,String outRefundNo,String refundID, String appId, String key, String mchId){
