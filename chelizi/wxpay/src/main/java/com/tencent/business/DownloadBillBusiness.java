...
public class DownloadBillBusiness {
    ...
    public void run(DownloadBillReqData downloadBillReqData, String key, String mchId, ResultListener resultListener) throws Exception {
        ...
        try {
            ...
            ReportReqData reportReqData = new ReportReqData(
                    ...
                    "",
                    "",
                    Configure.getIP(), downloadBillReqData.getAppid(), key, mchId
            );
