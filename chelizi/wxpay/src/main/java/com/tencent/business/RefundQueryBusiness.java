...
public class RefundQueryBusiness {
     ...
     * @throws Exception
     */
    public void run(RefundQueryReqData refundQueryReqData, String key, String mchId, RefundQueryBusiness.ResultListener resultListener) throws Exception {
        ...
        ReportReqData reportReqData = new ReportReqData(
                ...
                Configure.getIP(), refundQueryReqData.getAppid(), key, mchId
        );
