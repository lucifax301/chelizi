...
public class RefundBusiness {
     ...
     * @throws Exception
     */
    public void run(RefundReqData refundReqData, String key, String mchId, ResultListener resultListener) throws Exception {
        ...
        ReportReqData reportReqData = new ReportReqData(
                ...
                Configure.getIP(), refundReqData.getAppid(), key, mchId
        );
