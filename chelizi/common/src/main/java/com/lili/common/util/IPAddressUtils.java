...
public class IPAddressUtils {
	...
	public static String getAddresses(String content, String encodingString)
			throws UnsupportedEncodingException {
		// 这里调用pconline的接口
		String urlStr = "http://ip.taobao.com/service/getIpInfo.php"; //10qps
	...
	public static String getAddresses2(String content){
		String urlStr = "http://whois.pconline.com.cn/ip.jsp";
		String returnStr = getResult(urlStr, "ip=" +content, "gbk");
