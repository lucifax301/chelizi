...
public class ShareQuery extends BaseQuery {
	/**开始mybatis查询变量**/
	private String sid="And sid=#{param1.sid}";
	...
	private String recevieTemplate="And recevieTemplate=#{param1.recevieTemplate}";
	/**结束mybatis查询变量**/
	private String sqlField=" sid as sid,suid as suid,send_phone as sendPhone,send_type as sendType,send_user as sendUser,send_state as sendState,send_time as sendTime,send_total as sendTotal,recevie_name as recevieName,recevie_phone as receviePhone,recevie_user as recevieUser,recevie_state as recevieState,recevie_coupon as recevieCoupon,reg_name as regName,reg_pic as regPic,reg_type as regType,check_state as checkState,isdel as isdel,cuid as cuid,muid as muid,ctime as ctime,mtime as mtime,recevieTemplate as recevieTemplate ";

	public ShareQuery() {
		pkField="sid";
		setCacheSecond(getCacheSecond());
		projectVoKey="share.ShareVo";
	}
