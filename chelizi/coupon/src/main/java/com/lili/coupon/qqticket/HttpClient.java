...
public class HttpClient {
    ...
    public int send(Map<String, String> data, String encoding) throws Exception {
        String msg = this.getRequestParamString(data, encoding);
        return send(msg, encoding);
    }
     ...
     * @throws Exception
     */
    public int send(String msg, String encoding) throws Exception {
        try {
            HttpURLConnection httpURLConnection = createConnection(encoding);
            if (null == httpURLConnection) {
                throw new Exception("创建联接失败");
            }
            this.requestServer(httpURLConnection, msg,
                    encoding);
