 ...
 *
 */
public class CouponBTO extends BasePagedEntity{
	...
	public String getCoupontmpIds() {
		return coupontmpIds;
	}

	public void setCoupontmpIds(String coupontmpIds) {
		this.coupontmpIds = coupontmpIds;
	}
}